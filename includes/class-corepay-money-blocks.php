...
final class CorePay_Money_Blocks extends AbstractPaymentMethodType {
	...
	public function get_payment_method_data() {
		return array(
			'title'       => $this->gateway ? $this->gateway->title : $this->get_setting( 'title', __( 'CorePay Money', 'corepay-money-woocommerce' ) ),
			'description' => $this->gateway ? $this->gateway->description : $this->get_setting( 'description', __( 'Pay securely with CorePay Money.', 'corepay-money-woocommerce' ) ),
